...
import '../screens/pos/commandes_attente_screen.dart';
...
class AppRoutes {
  ...
  static const String commandesAttente = '/commandes-attente';
  ...
  static Map<String, WidgetBuilder> get routes => {
        ...
        commandesAttente: (context) => const CommandesAttenteScreen(),
